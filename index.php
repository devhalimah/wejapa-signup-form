...
<html>
  ...
  <body>
    ...
    <legend><h1>sign up now !!!</h1></legend>
	  <p>First Name: </p>
	  <input type="text" name="firstname" value="<?php echo htmlspecialchars($firstname);?>" autofocus>
	  ...
	  <p>Password: </p>
	  <input type="password" value="<?php echo htmlspecialchars($password);?>" name="password">
